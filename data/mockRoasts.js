...
export const hallOfFlame = [
  {
    ...
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=unicorn",
    roasterHandle: "valuationdestroyer",
    roastText: "From $1B valuation to $0 in 6 months. That's not a pivot, that's a nosedive.",
    defenseText: "We still have 200 employees. How many does your blog have?",
    bountyAmount: 1205,
    finalStatus: "defended",
    tier: "legendary",
    upvotes: 1847,
    spectatorContributions: 312,
    battleVotes: { roaster: 890, founder: 1102 },
    tags: ["unicorn", "valuation", "fall-from-grace"],
  ...
  },
  {
    ...
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=deleted",
    roasterHandle: "webarchivebot",
    ...
    tier: "legendary",
    upvotes: 1423,
    spectatorContributions: 278,
    tags: ["forgotten", "startup", "rip"],
    createdAt: "2026-06-20T14:30:00Z",
    legend: true,
  },
  {
    id: "hof-003",
    target: "@metaverse_mike",
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=metaverse",
    roasterHandle: "reality_checker",
    roastText: "You spent $2M building a virtual office nobody visits. Your real office is also empty. Consistency king.",
    defenseText: null,
    bountyAmount: 734,
    finalStatus: "expired",
    tier: "legendary",
    upvotes: 1156,
    spectatorContributions: 198,
    tags: ["metaverse", "vr", "money-pit"],
  ...
  },
  {
    ...
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=gpteverything",
    roasterHandle: "ai_realist",
  ...
  },
  {
    id: "hof-005",
    target: "@defi_dreamer",
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=defidreamer",
    roasterHandle: "tradfi_enjoyer",
    roastText: "Your DeFi protocol got hacked 3 times and you called each one a 'stress test.' The stress is on your investors.",
    defenseText: "We refunded every user within 48 hours. When's the last time a bank did that?",
    bountyAmount: 445,
    finalStatus: "defended",
    tier: "epic",
    upvotes: 756,
    spectatorContributions: 89,
    battleVotes: { roaster: 534, founder: 412 },
  ...
  {
    id: "hof-006",
    target: "@pitch_deck_pro",
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=pitchdeck",
    roasterHandle: "bootstrap_baron",
    roastText: "Your pitch deck has more animations than your product has features. Impressive PowerPoint engineering.",
    defenseText: null,
    bountyAmount: 312,
    finalStatus: "expired",
    tier: "epic",
    upvotes: 589,
    spectatorContributions: 67,
    tags: ["pitch-deck", "vc", "fundraising"],
    createdAt: "2026-08-22T09:00:00Z",
    legend: false,
  },
  {
    id: "hof-007",
    target: "@social_scheduler",
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=scheduler",
    roasterHandle: "organic_only",
    roastText: "A social media scheduler that can't even schedule its own launch date. The irony writes itself.",
    defenseText: "We launched. 10k users in week 1. Your 'organic growth' took 3 years to hit 500.",
    bountyAmount: 189,
    finalStatus: "defended",
    tier: "rare",
    upvotes: 412,
    spectatorContributions: 34,
    battleVotes: { roaster: 178, founder: 289 },
    tags: ["social-media", "scheduling", "launch"],
  ...
  },
  {
    id: "hof-008",
    target: "@crypto_ceo",
    targetAvatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=cryptoceo",
    roasterHandle: "sec_watcher",
    roastText: "Your token's whitepaper has more typos than your smart contract has lines of code. Both are equally audited.",
    defenseText: null,
    bountyAmount: 78,
    finalStatus: "cleared",
    tier: "rare",
